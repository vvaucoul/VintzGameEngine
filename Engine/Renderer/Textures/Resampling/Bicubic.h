...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/04/28 15:32:26 by vvaucoul          #+#    #+#             */
/*   Updated: 2025/04/28 15:35:02 by vvaucoul         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
namespace Engine {
	namespace Renderer {
		namespace Textures {
			...
			/**
			 * @brief Bicubic resampling algorithm for image resizing.
			 *
			 * Performs high-quality image resampling using bicubic interpolation.
			 * Suitable for smooth scaling of images with minimal aliasing.
			 */
			class Bicubic : public Resampling {
			public:
				/**
				 * @brief Resample image data using bicubic interpolation.
				 *
